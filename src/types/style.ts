...
export type HandleSOX<T> = Required<T> extends { sow: any } | { soh: any } ? Omit<T, 'sow' | 'soh'> & { shadowOffset?: ShadowStyleIOS['shadowOffset'] } : T

export type HandleTSOX<T> = Required<T> extends { tsow: any } | { tsoh: any } ? Omit<T, 'tsow' | 'tsoh'> & { textShadowOffset?: TextStyle['textShadowOffset'] } : T
