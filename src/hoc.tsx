...
import type { FlatList, FlatListProps, SectionList, SectionListProps, Animated, View, Text, Image } from 'react-native'
...
export const enhanceAnimatedViewWithRef = <T extends ComponentType<any>>(Component: T, opts?: UseStyleShorthandOptions) =>
  forwardRef<T, ComponentProps<typeof View>, SS.AnimatedView>(renderWithRef(Component), opts)
...
export const enhanceAnimatedTextWithRef = <T extends ComponentType<any>>(Component: T, opts?: UseStyleShorthandOptions) =>
  forwardRef<T, ComponentProps<typeof Text>, SS.AnimatedText>(renderWithRef(Component), opts)
...
export const enhanceAnimatedImageWithRef = <T extends ComponentType<any>>(Component: T, opts?: UseStyleShorthandOptions) =>
  forwardRef<T, ComponentProps<typeof Image>, SS.AnimatedImage>(renderWithRef(Component), opts)
