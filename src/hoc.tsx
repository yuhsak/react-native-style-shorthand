...
export const fc = <P extends {}={}, SS=ExtractSSType<P>>(Component: ComponentType<StyleInjectedProps<P, SS>>, opts?: UseStyleShorthandOptions) => {
  const component:FC<StyleEnhancedProps<P, SS>> = props => (
    <Component {...useStyleShorthand<P, SS>(props, opts)} />
  )
...
export const forwardRef = <T, P={}, SS=ExtractSSType<P>>(render: ForwardRefRenderFunction<RefType<T>, StyleInjectedProps<P, SS>>, opts?: UseStyleShorthandOptions) => {
  const component = React.forwardRef<RefType<T>, PropsWithChildren<StyleEnhancedProps<P, SS>>>((props, ref) => (
    render(useStyleShorthand<P, SS>(props, opts), ref))
  )
 ...
 * (Typically for ClassComponent)
*/
export const enhanceViewWithRef = <T extends ComponentType<any>>(Component: T, opts?: UseStyleShorthandOptions) => (
  enhanceWithRef<T, SS.View>(Component, opts)
)
 ...
 * (Typically for ClassComponent)
*/
export const enhanceTextWithRef = <T extends ComponentType<any>>(Component: T, opts?: UseStyleShorthandOptions) => (
  enhanceWithRef<T, SS.Text>(Component, opts)
)
 ...
 * (Typically for ClassComponent)
*/
export const enhanceImageWithRef = <T extends ComponentType<any>>(Component: T, opts?: UseStyleShorthandOptions) => (
  enhanceWithRef<T, SS.Image>(Component, opts)
)
